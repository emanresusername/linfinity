...
object Setting {
  ...
  case object BlankDisplay
      extends Setting('_', "the characters that fill the space between/around the lins")
  ...
  case object DieChance
      extends Setting(0.002d, "chance a lin will die each row. function of the age of the lin")
  case object LinDisplays extends Setting("0123456789", "the characters that can represent a lin")
}
